...
# (list) Application requirements (Combined python3 and pygame-ce)

requirements = python3, pygame-ce, Pillow, arabic_reshaper, python-bidi, requests, setuptools, certifi, openssl, chardet, idna, urllib3
