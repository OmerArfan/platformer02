...
local lvl4 = {
	...
	blocks = {
		...
		{x = 1300,  y = -1400, w = 100, h = 1520},
		{x = 1300,  y = -1500, w = 1000, h = 100},
		{x = 1750,  y = -980, w = 100, h = 1530},
		{x = 1850,  y = -650, w = 200, h = 100},
		{x = 3500,  y = -1200, w = 100, h = 750},
		{x = 4700,  y = -650, w = 600, h = 100},
		{x = 5200,  y = -600, w = 0, h = 0},
	},
	spikes = {
		{{1005, 450}, {1050, 400}, {1095, 450}},
		{{755, 120}, {800, 170}, {845, 120}},
		{{3525, -1200}, {3550, -1225}, {3575, -1200}},
	},
	saws = {
		{x = 0, y = 450, radius = 74, type = 'static'},
		{radius = 40, orbit_radius = 300, angle = 0, speed = 4, block = 7, type = 'rotating'},
		--{radius = 60, speed = 14, x = 3400, y = 600, max = 630, min = -200, dir = -1, type = 'rushing_y'},
		--{radius = 60, speed = 11, x = 3800, y = 600, max = 630, min = -200, dir = -1, type = 'rushing_x'},
	},
	moving_block = {
	    {x = 2800, y = -770, w = 100, h = 50, axis = "x", direction = 1, speed = 11, limit_x = 2200, limit_y = 3450},
		{x = 4100, y = -770, w = 100, h = 50, axis = "x", direction = 1, speed = 11, limit_x = 4140, limit_y = 5600},
	},
	grav_weak = {
		{x = 1300, y = 330}
	},
	...
	lasers = {
		{x = 2050, y = -605, w = 2650, h = 10},
	},
	flags = {{x = 1900, y = -750, w = 100, h = 125, save_x = 1880, save_y = -770}},
	exit = {x = 5600, y = 100, w = 140, h = 180}, 
    next_page = "quit",
}