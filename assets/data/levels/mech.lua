local sub1 = {
	...
	lvl5 = {
		...
		spikes = {
			{{120, 525}, {200, 475}, {280, 525}},
			{{290, 525}, {370, 475}, {450, 525}},
			{{460, 525}, {540, 475}, {620, 525}},
	...
	lvl6 = {
		...
		saws = {
			{radius = 70, speed = 4, x = 800, y = 400, max = 800, min = 400, type = 'moving_y'},
			{radius = 70, speed = 5, x = 1400, y = 700, max = 900, min = 500, type = 'moving_y'},
			{radius = 95, speed = 6, x = 3350, y = -50, max = 3900, min = 3300, type = 'moving_x'},
			{x = 4600, y = 570, radius = 80, type = 'static'},
		},
		key_block_pairs_timed = {
			{
				key = {x = 300, y = 500, radius = 30, color = {255, 119, 0}},
				block = {x = 1900, y = 400, w = 100, h = 200},
				collected = false,
				duration = 5000,
				locked_time = nil
			},
		...
		text = {
			timed_coin_message_2 = {name = "timed_coin_message_2", fallback = "time. Run before they close again, or at worst, crush you...", color = {255, 128, 0}, x = -20, y = 370},
			timed_coin_message = {name = "timed_coin_message", fallback = "Orange coins are timed! They open blocks for a limited", color = {255, 128, 0}, x = 0, y = 320}
		},
