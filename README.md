...
If you are a developer, though, and you feel like you wish to make a contribution or fix an issue, feel free to fork this repository and fix the issue you found, and then start a pull request! Use this [manual](https://github.com/OmerArfan/platformer02/blob/main/gameinfo/DevSetup.md) for guidance.
