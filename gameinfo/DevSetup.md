> ⚠️ Developer Build Guide This guide is for those who want to run from source or contribute. For players, please use the [Releases page](https://github.com/OmerArfan/platformer02/releases).

1) Setup IDE: Download and install [VSCode](https://code.visualstudio.com/Download).
...
#### Contributions: Feel free to mess around with the code! If you add something cool, submit a Pull Request (PR) and I'll check it out!
